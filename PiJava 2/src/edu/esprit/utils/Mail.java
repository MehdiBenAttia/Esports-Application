...
public class Mail {
   public static void sendMail(String recepient,int code) throws Exception{
        ...
        String myAccountEmail="mohamedkhalil.trabelsi@esprit.tn";
        String password="khalil-2";
...
"    <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-family: 'Crimson Text', serif; font-size: 14px; line-height: 19.6px;\"><strong><span style=\"font-size: 22px; line-height: 30.8px;\">E-Tsports</span></strong></span></p>\n" +
