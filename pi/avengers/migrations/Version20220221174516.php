 ...
 */
final class Version20220221174516 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE jeux CHANGE type type VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jeux CHANGE nom nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE image image VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE type type VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE dates dates VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
