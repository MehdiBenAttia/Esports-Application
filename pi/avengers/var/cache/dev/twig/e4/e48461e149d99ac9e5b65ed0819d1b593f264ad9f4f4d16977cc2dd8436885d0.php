...
class __TwigTemplate_43ea3fcaab45d08ec5c898d38da57143be40f2d3b02219d8ea8ea5336c25634c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["var"]) {
            ...
            // line 93
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("U", ["id" => twig_get_attribute($this->env, $this->source, $context["var"], "id", [], "any", false, false, false, 93)]), "html", null, true);
            echo "\" ><i class=\"fa-solid fa-pen\"></i>Update</a>
                            </td>
                            <td><a class=\"btn btn-outline-danger\" type=\"button\" href=\" ";
            // line 95
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("d", ["id" => twig_get_attribute($this->env, $this->source, $context["var"], "id", [], "any", false, false, false, 95)]), "html", null, true);
...
{#    </div>#}
    ...
    <div class=\"col-lg-12 stretch-card\">
        <div class=\"card\">
            <div class=\"card-body\">
                <h4 class=\"card-title\">Les jeux disponibles</h4>
                <a class=\"btn btn-outline-dark \" href=\"{{ path('A') }}\" ><i class=\"fa-solid fa-circle-plus\"></i> Ajouter un nouveau jeu</a>
                ...
                <div class=\"table-responsive pt-3\">
                    <table class=\"table table-bordered table-hover table-striped\">
                        ...
                        <tbody>
                            ...
                            <td>
                                <a class=\"btn btn-outline-dark\" type=\"button\" href=\"{{ path('U',{'id':var.id}) }}\" ><i class=\"fa-solid fa-pen\"></i>Update</a>
                            </td>
                            <td><a class=\"btn btn-outline-danger\" type=\"button\" href=\" {{ path('d',{'id':var.id}) }} \" ><i class=\"fa-solid fa-trash\"></i>Delete   </a></td>
                        </tr>
                        {% endfor %}
                        </tbody>
                    </table>
