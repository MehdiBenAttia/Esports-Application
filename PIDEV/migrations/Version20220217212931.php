 ...
 */
final class Version20220217212931 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponses ADD date VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponses DROP date, CHANGE consult consult VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
