...
class UserController extends AbstractController
{
     ...
     * @param UserRepository $repository
     * @return Response
     * @Route("/userback/afficheuserback",name="userback/afficheruserback")
     */
    ...
    /**
     * @Route("/userback/supprimeruserback/{id}",name="dback")
     * @param $id
     * @param UserRepository $repository
     * @return RedirectResponse
     */
     ...
     * @param Request $request
     * @return Response
     * @Route("/userback/AddUserback",name="aback")
     */
     ...
     */
    function modifier(UserRepository $repository, $id, Request $request, \Swift_Mailer $mailer)
    {
        $user = $repository->find($id);
        $form = $this->createForm(UserType::class, $user);
        $form->handleRequest($request);
    ...
    function modifiermdp(UserRepository $repository, $id, Request $request, \Swift_Mailer $mailer, UserPasswordEncoderInterface $passwordEncoder)
    {
        ...
        return $this->render("user/updatemdp..html.twig", ['f' => $form->createView()]);
    ...
    function mdp(UserRepository $repository, Request $request, \Swift_Mailer $mailer)
    {
        ...
        return $this->render("/user/mdp.html.twig", ['f' => $form->createView()]);

    }


    /**
     * @Route("/userback/updateback/{id}",name="mback")
     */
    ...
    function blockuser($id, UserRepository $repository)
    {
        ...
        return $this->redirectToRoute("userback/afficheruserback");
