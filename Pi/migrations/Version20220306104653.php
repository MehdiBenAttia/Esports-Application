 ...
 */
final class Version20220306104653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresse ADD code_promo VARCHAR(8) NOT NULL');
