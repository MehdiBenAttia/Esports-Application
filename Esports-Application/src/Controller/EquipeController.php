...
class EquipeController extends AbstractController
{
     ...
     * @Route("f/deletequipe/{id}",name="deletequipe")
     */
     ...
     * @param EquipeRepository $repository
     * @return RedirectResponse
     * @Route("f/deletequipeback/{id}",name="deletequipeback")
     */
     ...
     * @param EquipeRepository $repository
     * @return Response
     * @Route("f/afficheequipe",name="afficheequipe")
     */
    ...
    {$session=$request->getSession();
        ...
        return $this->render('front/equipe/afficheequipe.html.twig', [
            'u' => $users]);
     ...
     * @param EquipeRepository $repository
     * @return Response
     * @Route("/back/equipeback/afficheequipeback",name="afficheequipeback")
     */
    ...
    {$session=$request->getSession();
        ...
        $users = $repository->findAll();
        return $this->render('/back/equipeback/afficheequipeback.html.twig', [
            'u' => $users]);
     ...
     * @Route("f/ajouterequipe",name="ajouterequipe")
     */
    ...
    { $session=$request->getSession();
        ...
        return $this->render('front/equipe/ajouterequipe.html.twig',[
     ...
     * @param Request $request
     * @return RedirectResponse|Response
     * @Route("/back/equipeback/ajouterequipeback",name="ajouterequipeback")
     */
    ...
    { $session=$request->getSession();
        ...
        return $this->render('back/equipeback/ajouterequipeback.html.twig',[
            'forme'=>$form->createView()
        ]);
    }
     ...
     * @param $id
     * @return RedirectResponse
     * @Route("f/ajouterjoueurs/{id}",name="aj")
     */
     ...
     * @param $id
     * @return RedirectResponse
     * @Route("/back/equipeback/ajouterjoueursback/{id}",name="ajback")
     */
     ...
     * @param Request $request
     * @return RedirectResponse|Response
     * @Route("f/modiferequipe/{id}",name="modifierequipe")
     */
    ...
    {$session=$request->getSession();
        ...
        return $this->render("front/equipe/updateequipe.html.twig",['fe'=>$form->createView()]);
    }
     ...
     * @param Request $request
     * @return RedirectResponse|Response
     * @Route("/back/equipeback/modiferequipeback/{id}",name="modifierequipeback")
     */
    ...
    {$session=$request->getSession();
        ...
        return $this->render("back/equipeback/updateequipeback.html.twig",['fe'=>$form->createView()]);
    }
     ...
     * @param Request $request
     * @return Response
     * @Route("f/afficherjoueurs/",name="afficherjoueurs")
     */
    function afficherJoueurs(EquipeRepository $repository,Request $request)
    {
        ...
        return $this->render('front/equipe/joueurs.html.twig', [
            'u' => $equipe]);
     ...
     * @param Request $request
     * @return Response
     * @Route("/back/equipeback/afficherjoueursback/",name="afficherjoueursback")
     */
    function afficherJoueursback(EquipeRepository $repository,Request $request)
    {
        ...
        $ide=$session->get('ide');
        $equipe=$repository->find($ide);
        return $this->render('back/equipeback/joueursback.html.twig', [
            'u' => $equipe]);
     ...
     * @param UserRepository $rep
     * @return RedirectResponse
     * @Route ("f/supprimerjoueurs/{id}",name="supprimerjoueurs")
     */
     ...
     * @param UserRepository $rep
     * @return RedirectResponse
     * @Route ("/back/equipeback/supprimerjoueursback/{id}",name="supprimerjoueursback")
     */
     ...
     * @param UserRepository $rep
     * @return RedirectResponse
     * @Route ("f/suppequipe",name="suppequipe")
     */
     ...
     * @param UserRepository $rep
     * @return RedirectResponse
     * @Route ("back/suppequipeback",name="suppequipeback")
     */
    function suppequipeback(Request $request,UserRepository $rep)
    {
        $user1 = $this->get('security.token_storage')->getToken()->getUser();
        if($user1 instanceof User)
        {
