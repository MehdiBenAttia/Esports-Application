...
class LivreurController extends AbstractController
{
    ...
    {
        return $this->render('back/livreur/index.html.twig', [
     ...
     * @return Response
     * @Route("/back/affichelivreur",name="affichelivreur")
     */
    function Affiche(LivreurRepository $repository) //meme chose que metre 33 ligne
    {
        ...
        return $this->render('back/livreur/affiche.html.twig',['c'=>$livreur]);
     ...
     * @Route ("/back/supprimerlivreur/{id}", name="supprimerlivreur")
     */
     ...
     * @param Response
     * @Route ("/back/ajouterlivreur", name="ajouterlivreur")
     */
    function Ajout(Request $request){
        ...
        return $this->render('back/livreur/ajout.html.twig',['f'=>$form->createView()]);
     ...
     * @param LivreurRepository $repository
     * @return Response
     * @Route ("/back/modifierlivreur/{id}",name="modifierlivreur")
     */
    public function modify(Request $request, int $id,LivreurRepository $repository): Response
    {
        ...
        return $this->render("back/livreur/modifier.html.twig", [
