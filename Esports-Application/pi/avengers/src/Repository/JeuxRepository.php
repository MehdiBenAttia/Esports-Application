...
class JeuxRepository extends ServiceEntityRepository
{
    ...
    function  nbr()
    {
        ...
        $sql='SELECT jeux.id,jeux.nom,jeux.image,jeux.dates,categorie_c.nom as c ,count(competition.jeux_id) as f FROM 
                                                                                   competition RIGHT JOIN 
                                                                                       jeux on (competition.jeux_id=jeux.id) 
                                                                                       JOIN categorie_c
                                                                                           on (categorie_c.id=jeux.categorie_id) GROUP by
                                                                                                (jeux.id); ';
